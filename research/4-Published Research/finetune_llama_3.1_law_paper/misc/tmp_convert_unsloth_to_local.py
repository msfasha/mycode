...
# %ip install "unsloth[colab-new] @ git+https://github.com/unslothai/unsloth.git" # Original code, for colab i guess
%pip install "unsloth[cu121] @ git+https://github.com/unslothai/unsloth.git" # The one I got from chatGPT
...
%pip install --no-deps xformers==0.0.28.post1 trl peft accelerate bitsandbytes
