# This file worked fine on the Jordanian traffic law document
...
input_file = "/home/me/mywork/nlp/nlp_experiments/data/traffic_law.txt"
output_file = "/home/me/mywork/nlp/nlp_experiments/data/testing_traffic_law_qa_pairs.txt"
max_tokens = 3000
chunk_size = 500
chunk_overlap = 50
...
# Sometimes the chunk size exceeds the maximum defined chunk size which causes and error
# when using openai api i.e. exceed maximum token size, therefore the function below examine the chunks and
# split the larger ones into small chunks
